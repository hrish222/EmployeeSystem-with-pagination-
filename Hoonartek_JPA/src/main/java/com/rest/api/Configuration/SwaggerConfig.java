...
public class SwaggerConfig {
	...
	private ApiInfo metaData() {
		return new ApiInfoBuilder()
				.title("Employee Handle - Spring Boot Swagger Configuration")
				.description("\"Swagger Configuration for My Application\"")
				.version("1.1.0")
				.license("Apache 2.0")
				.licenseUrl("https://www.apache.org/licesen.html")
				.contact(new Contact("Hnrishikesh Nalavade","hrishikeshnalavade22@gmail.com","www.linkdin.com/in/hrishikesh-nalavade"))
				.build();
